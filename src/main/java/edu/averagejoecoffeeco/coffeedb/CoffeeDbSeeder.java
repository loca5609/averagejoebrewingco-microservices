...
public class CoffeeDbSeeder implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Coffee vanilla = new Coffee("Vanilla Blend", "Light", "Rich", "Low", "Velvety", "Rich", "USA", "Great Farms",
				...
				// roast, aroma, acidity, body, flavor, country, farm, production, Image Url,
        // inventory, price
        Coffee lastMinute1 = new Coffee("Light Roast","Nutty","Low","Full","Slightly Sweet","USA","Good ol Farms","Organic",
		...
		Coffee lastMinute2 = new Coffee("Blacker than the Blackest Black times Infinity Roast","Cursed","VERY HIGH","NONE","BITTER","FROM THE HILLS OF COLOMBIA","Duncan Hills Coffee","BRUTAL","https://d1ielco78gv5pf.cloudfront.net/assets/clear-495a83e08fc8e5d7569efe6339a1228ee08292fa1f2bee8e0be6532990cb3852.gif",666,6.66);
		Coffee why = new Coffee("Good Coffee","Sweet","Medium","Light","Good?","Colombia","Great Farms",
